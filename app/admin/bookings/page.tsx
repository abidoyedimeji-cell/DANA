...
import { getAdminDateInvites } from "@/lib/actions/admin-actions"
...
export default function AdminBookingsPage() {
  ...
  const handleExport = (format: string) => {
    window.open(`/api/admin/export/dates?format=${format}`, "_blank")
  }
  ...
  return (
    <div className="p-8 max-w-7xl">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-white">Bookings / Date requests</h1>
